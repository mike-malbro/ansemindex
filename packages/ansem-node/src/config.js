 ...
 */
export const config = {
  cellId: str('CELL_ID', cell.cellId || 'my-ansem-node'),
  ...
  hubUrl: str(
    'HUB_URL',
    'https://hub-production-7867.up.railway.app',
  ),
  influenceLeaderLp: str(
    'INFLUENCE_LEADER_LP',
    cell.influence?.leaderLp ||
      'HpJbzERP44V21mKGRDDUArb9JJaL9NdPSgXzZ9uyieVB',
  ),

  mainWallet: str('MAIN_WALLET', cell.wallets?.main || ''),
  /** Your LP — leave blank until you set it. Do not inherit Mike's wallet. */
  lpWallet: str('LP_WALLET', cell.wallets?.lp || ''),
